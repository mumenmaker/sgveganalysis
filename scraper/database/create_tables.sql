...
-- Add unique constraint to prevent duplicate restaurants based on location
-- This will prevent the same restaurant location from being inserted multiple times
-- Using latitude and longitude as the unique constraint is more reliable than name
