...
│   ├── create_tables.sql      # Basic table creation
│   ├── setup_fresh_database.sql # Complete database setup
│   ├── DATABASE_SETUP.md      # Database setup guide
│   └── check_database_data.py # Database verification
├── debug/                     # Debug and testing files
│   ├── debug_coordinates.py   # Coordinate extraction debug
│   ├── debug_page_structure.py # Page structure analysis
│   ├── analyze_html.py        # HTML analysis
│   └── check_database.py      # Database checking
├── examples/                  # Example usage files
│   ├── example_usage.py       # Basic usage examples
│   └── resume_example.py      # Resume functionality example
├── tests/                     # Test files
...
│   └── singapore_restaurants.json # Scraped data
└── docs/                      # Documentation
