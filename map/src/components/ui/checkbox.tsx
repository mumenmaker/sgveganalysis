  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        // Only apply default primary colors if no custom colors are provided
        !className?.includes('data-[state=checked]:bg-') && "data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground data-[state=checked]:border-primary",
        className
      )}
      {...props}
    >
