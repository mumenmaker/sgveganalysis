  ...
  return (
    <div className={`h-screen w-full flex flex-col transition-colors duration-300 ${
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg transition-colors duration-300 shadow-sm ${
                  isDarkMode 
      ...
      <div className="flex-1 flex w-full overflow-hidden">
                {/* Filters Sidebar */}
                {showFilters && (
                  <div className={`w-full sm:w-80 backdrop-blur-sm border-r overflow-y-auto transition-colors duration-300 ${
                    isDarkMode 
